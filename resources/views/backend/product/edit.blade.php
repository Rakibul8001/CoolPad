      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="M"  @if( in_array( "M",$data ) ) selected @endif>Magenda</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="new" {{(($product->condition=='new')? 'selected':'')}}>Latest</option>
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>Featured</option>
          </select>
        </div>
