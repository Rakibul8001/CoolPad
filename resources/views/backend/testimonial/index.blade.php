...
@section('title','CoolPad || testimonial Page')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Testimonials List</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        <table class="table table-bordered" id="testimonial-dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th>S.N.</th>
              <th>Name</th>
                ...
                <tr>
                    ...
                    <td>
                        @if($testimonial->photo)
                            <img src="{{asset($testimonial->photo)}}" class="img-fluid zoom" style="max-width:80px" alt="{{$testimonial->photo}}">
                        @else
