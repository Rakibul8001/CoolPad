...
<div class="xm-navbar">
  <div class="xm-navbar__container">
    <div class="xm-navbar__title">
      <h1><span data-key="" class="xm-text header" data-type="text" data-id="wh0pgc1o1l">Cool Bass Buds</span></h1>
    ...
    <div class="xm-navbar__nav" data-id="5jotnt4w9x">
      <ul>
        ...
        <li class="xm-navbar__nav-item">
          <a href="{{ $wheretobuy[3] }}" target="_self" class="xm-navbar-btn" id="nav-buy_now">Buy Now</a>
        </li>
      </ul>
    </div>
  </div>
...
<div id="single-product-det" class="xm-product-box J_section-box">
  <section class="pdet-weight">
    <img src="{{asset('frontend/img/accessories-banner.jpg')}}" alt="">
  </section>
  <section class="pdet-weight">
    <img src="{{asset('frontend/img/adetails2.jpg')}}" alt="">
  </section>
  <section class="pdet-weight">
    <img src="{{asset('frontend/img/adetails3.jpg')}}" alt="">
  </section>
  <section class="pdet-weight">
    <img src="{{asset('frontend/img/adetails4.jpg')}}" alt="">
  </section>
  <section class="pdet-weight">
    <img src="{{asset('frontend/img/adetails5.jpg')}}" alt="">
  </section>
  <section class="pdet-weight">
    <img src="{{asset('frontend/img/adetails6.jpg')}}" alt="">
  </section>
  <section class="pdet-weight">
    <img src="{{asset('frontend/img/adetails7.jpg')}}" alt="">
  </section>
  <section class="pdet-weight">
    <img src="{{asset('frontend/img/adetails8.jpg')}}" alt="">
  </section>
