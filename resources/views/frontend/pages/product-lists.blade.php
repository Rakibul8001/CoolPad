...
<form action="{{route('shop.filter')}}" method="POST">
	@csrf
	<!-- Product Style 1 -->
	<section id="shop-bg" class="product-area shop-sidebar shop-list shop section">
		<div class="container">
			<div class="row">
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="shop-top">
								...
								<ul class="view-mode">
									<li class="active"><a href="{{route('product-grids')}}"><i
							...
							<div class="row">
								...
								<div class="col-lg-8 col-md-6 col-12">
									<div class="list-content">
										...
										<p class="des pt-2">{!! html_entity_decode($product->description) !!}</p>
