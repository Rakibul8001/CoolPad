							...
							<div class="flexslider-thumbnails">
								<ul class="slides">
									...
									<li data-thumb="{{ asset($data) }}" rel="adjustX:10, adjustY:">
										<img src="{{ asset($data) }}" alt="{{$data}}" class="zoom">
									</li>
									@endforeach
								</ul>
							</div>
								...
								<div class="form-group mb-0">
									<div class="col-md-4">
										<div class="row">
											...
											// dd($sizes);
											@endphp
											<label for="status" class="col-form-label">Color <span
					...
					<div class="product-info">
						<div class="nav-main">
							...
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#description1"
										role="tab">Product Information</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#description2"
										role="tab">Shipping Policy</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#description3"
										role="tab">Return Policy</a></li>
						...
						<div class="tab-content" id="myTabContent">
							<!-- Description1 Tab -->
							<div class="tab-pane fade show active" id="description1" role="tabpanel">
							...
							<!-- Description2 Tab -->
							<div class="tab-pane fade show" id="description2" role="tabpanel">
								<div class="tab-single">
									<div class="row">
										<div class="col-12">
											<div class="single-des">
							...
							<!-- Description3 Tab -->
							<div class="tab-pane fade show" id="description3" role="tabpanel">
								<div class="tab-single">
									<div class="row">
										<div class="col-12">
											<div class="single-des">
