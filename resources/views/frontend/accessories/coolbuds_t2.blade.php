...
<div class="xm-navbar">
        <div class="xm-navbar__container">
            ...
            <div class="xm-navbar__nav" data-id="5jotnt4w9x">
                <ul>
                    ...
                    <li class="xm-navbar__nav-item xm-navbar__nav-item--current">
                        <a href="{{ route('coolbuds-t2-details') }}" target="_self" class="" id="nav-overview">Specs</a>
                    </li>                    
 ...
 <div id="single-product-det" class="xm-product-box J_section-box">
    <section class="pdet-weight">
      <img src="{{asset('frontend/img/Coolpad-coolbuds-T2.jpg')}}" alt="">
    </section> 
  ...
  <main class="poco-x3-pro">
      ...
      <div class="section section_02 is-visible" data-type="bg" data-id="g0zxgmm5a9">
        <div class="text-content"><span data-key="overview_1" class="xm-text title bold wow slideInDown" data-type="text" data-id="xl8kh9ftnb">Key Points</span>     
            ...
            <span data-key="overview_6" class="xm-text desc regular wow slideInLeft" data-type="text" data-id="5v3rjwj379">35 mah Polymer lithium ion battery</span>
            <div class="line wow slideInLeft"></div>
            <span data-key="overview_6" class="xm-text desc regular wow slideInLeft" data-type="text" data-id="5v3rjwj379">32Ω±15% Speaker Impedance</span>
            <div class="line wow slideInLeft"></div>
            <span data-key="overview_6" class="xm-text desc regular wow slideInLeft" data-type="text" data-id="5v3rjwj379">V5.0 Bluetooth standard</span>
            <div class="line wow slideInLeft"></div>
            <span data-key="overview_6" class="xm-text desc regular wow slideInLeft" data-type="text" data-id="5v3rjwj379">Airoha AB1536U Chipset</span>
            <div class="line wow slideInLeft"></div>
