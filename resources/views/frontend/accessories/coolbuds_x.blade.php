...
<div class="xm-navbar">
        <div class="xm-navbar__container">
            <div class="xm-navbar__title">
                <h1><span data-key="" class="xm-text header" data-type="text" data-id="wh0pgc1o1l">Coolpad coolbuds X</span></h1>
            ...
            <div class="xm-navbar__nav" data-id="5jotnt4w9x">
                <ul>
                    <li class="xm-navbar__nav-item xm-navbar__nav-item--current">
                        <a href="{{ route('coolbuds-x') }}" target="_self" class="" id="nav-overview">Overview</a>
                    </li> 
                    <li class="xm-navbar__nav-item xm-navbar__nav-item--current">
                        <a href="{{ route('coolbuds-x-details') }}" target="_self" class="" id="nav-overview">Specs</a>
                    </li>                    
 ...
 <div id="single-product-det" class="xm-product-box J_section-box">
    <section class="pdet-weight">
      <img src="{{asset('frontend/img/Coolpad-coolbuds-X.jpg')}}" alt="">
    </section> 
  ...
  <main class="poco-x3-pro">
      ...
      <div class="section section_02 is-visible" data-type="bg" data-id="g0zxgmm5a9">
        <div class="text-content"><span data-key="overview_1" class="xm-text title bold wow slideInDown" data-type="text" data-id="xl8kh9ftnb">Key Points</span>     
            ...
            <span data-key="overview_6" class="xm-text desc regular wow slideInLeft" data-type="text" data-id="5v3rjwj379">50mAhPolymer lithium ion battery</span>
            ...
            <div class="line wow slideInLeft"></div>
            <span data-key="overview_6" class="xm-text desc regular wow slideInLeft" data-type="text" data-id="5v3rjwj379">Airoha,AB1562A Chipset</span>
            <div class="line wow slideInLeft"></div>
