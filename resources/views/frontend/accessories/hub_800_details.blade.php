    ...
    <div class="xm-navbar">
        <div class="xm-navbar__container">
            <div class="xm-navbar__title">
                <h1><span data-key="" class="xm-text header" data-type="text" data-id="wh0pgc1o1l">Cool HUB-800</span></h1>
            ...
            <div class="xm-navbar__nav" data-id="5jotnt4w9x">
                <ul>
                    <li class="xm-navbar__nav-item xm-navbar__nav-item--current">
                        <a href="{{ route('hub-800') }}" target="_self" class="" id="nav-overview">Overview</a>
                    </li> 
 ...
 <main class="specs">
     <div class="specs-header">
            ...
            <div class=" section_01 is-visible" data-type="bg" data-id="wseklrj0az">
                <img class="img" src="{{ asset('frontend/img/Cool-HUB-800.jpg') }}">   
            </div>    
            ...
            <div class="sectionspe specs05" data-type="bg" data-id="buh83nrolq">
                <div class="text-container">
                    ...
                    <div class="right">
                        <span data-key="Spec_26" class="xm-text f20 f-medium" data-type="text" data-id="zrzkxxtn4t">supports up to 5GB data transfer, supports charging maximum 2A output.</span>                      
            ...
            <div class="sectionspe specs08" data-type="bg" data-id="hgz66jx8lb">
                <div class="text-container">
                    ...
                    <div class="right">
                        <span data-key="Spec_71" class="xm-text f16 f-regular" data-type="text" data-id="wmne2xj4ls">supports PD3.0 and up to 100W power input.</span>
            ...
            <div class="sectionspe specs11" data-type="bg" data-id="o9oq3txbou">
                <div class="text-container">
                    ...
                    <div class="right">
                        <span data-key="Spec_86" class="xm-text f16 f-regular" data-type="text" data-id="ccrgamkoyx">support HDMI up to 4K (3840*2160)@60HZ resolution output</span>                                         </div>
                </div>
            </div>
            <div class="sectionspe specs12" data-type="bg" data-id="svaq8e5r7x">
                <div class="text-container">
                    <div class="left">
                        <span data-key="Spec_88" class="xm-text f28 f-medium" data-type="text" data-id="y9zi91sg1h">Micro SD*1</span>
                    </div>
                    <div class="right">
                        <span data-key="Spec_89" class="xm-text f16 f-regular" data-type="text" data-id="4x6lbs1mau">support v1.0/v1.1/v2.0/SDHC specification.</span>
                    </div>
                </div>
            </div> 
            <div class="sectionspe specs09" data-type="bg" data-id="1nudpwtnme">
                <div class="text-container">
                    <div class="left">
                        <span data-key="Spec_75" class="xm-text f28 f-medium" data-type="text" data-id="85fszad7xq">SDXC*1</span>
                    </div>
                    <div class="right">
                        <span data-key="Spec_76" class="xm-text f16 f-bold" data-type="text" data-id="ioorl0lgb4">supports up to 300M/S transfer rate.</span>
            ...
            <div class="sectionspe specs09" data-type="bg" data-id="1nudpwtnme">
                <div class="text-container">
                    <div class="left">
                        <span data-key="Spec_75" class="xm-text f28 f-medium" data-type="text" data-id="85fszad7xq">RJ-45_1000M network port*1</span>
                    </div>
                    <div class="right">
